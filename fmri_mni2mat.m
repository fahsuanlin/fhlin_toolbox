function [index3d, index1d]=fmri_mni2mat(inp,matrix_size)
% fmri_mni2mat converting MNIh space coordinates to matrix indices
%
% output=fmri_mni2mat(input, matrix_size)
%
% input: a vector of x, y,and z coordinate of MNI space
