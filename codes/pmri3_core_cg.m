function [recon,b,delta]=pmri3_core_cg(varargin);
%
%	pmri3_core_cg		perform 3D SENSE reconstruction using conjugated gradient method
%
%
%	[recon,b,delta]=pmri3_core_cg('Y',Y,'S',S,'C',C,'K',K,'flag_display',1);
%
%	INPUT:
%	Y: input data of [n_PE1, n_PE2, n_PE3, n_chan]. 
%		n_PE1: # of phase encoding in direction 1
%		n_PE2: # of phase encoding in direction 2
%		n_PE3: # of phase encoding in direction 3
%		n_chan: # of channel
...
%		n_chan: # of channel
%	K: 2D k-space sampling matrix with entries of 0 or 1 [n_PE1, n_PE2, n_PE3].
%		n_PE1: # of phase encoding in direction 1
%		n_PE2: # of phase encoding in direction 2
%		n_PE3: # of phase encoding in direction 3
...
%
%	OUTPUT:
%	recon: 3D un-regularized SENSE reconstruction [n_PE1, n_PE2, n_PE3].
%		n_PE1: # of phase encoding in direction 1
%		n_PE2: # of phase encoding in direction 2
%		n_PE3: # of phase encoding in direction 3
%	b: history of all 3D un-regularized SENSE reconstruction [n_PE1, n_PE2, n_PE3, n_CG].
%		n_PE1: # of phase encoding in direction 1
%		n_PE2: # of phase encoding in direction 2
%		n_PE3: # of phase encoding in direction 3
