function [seq]=fmri_pls_perm_100(datamat_struct)
%
% fmri_pls_perm_100(datamat_struct)    this gives the randomized permuted sequence across tasks, while maintaing subjects' order
%
%
