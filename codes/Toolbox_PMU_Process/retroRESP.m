...
%   simplified least squares procedures. Anal Chem 36:1627??639.
%
...
%     sR = sgolayfilt(R,3,1199);%yitien 2017/10/12
  dR = diff(sR);
%   dR(abs(dR)<=std(dR))=0;%yitien 2017/10/12
%   sR(abs(dR)<=std(dR))=median(sR);%yitien 2017/10/12
