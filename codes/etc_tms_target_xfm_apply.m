function results = etc_tms_target_xfm_apply(app, coil_center, coil_orientation, coil_up)
% etc_tms_target_xfm_apply apply the transformation matrix to TMS coil
% objects
%
% etc_tms_target_xfm_apply(app, coil_center, coil_orientation, coil_up)
%
% app: Matlab app of TMS coil navigation. This is required for accessing
...
%
% 
% Example: results = target_apply_xfm(app, object_xfm(1:3,4).*1e3, -object_xfm(1:3,3), object_xfm(1:3,2));
%
% fhlin@May 30 2024
%
