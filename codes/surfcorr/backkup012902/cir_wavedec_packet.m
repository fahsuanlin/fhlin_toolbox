function [output, varargout]=cir_wavedec_packet(input,L,levels_pkt, h0,h1, varargin)
% [output, varargout]=CIR_WAVEDEC_PACKET(INPUT,L,levels_pkt,h0,h1, WHICH_BAND [,WHICH_BAND,...])
...
%   fprintf('%s\t', str);
   ...
   sub_input=cir_wavedec_full(sub_input,levels_pkt,h0,h1);
