function z=etc_f(a,baseline_idx,varargin)
%
% etc_f    calculates the F-score of a 2D matrix
%
% z=etc_f(data,baseline_idx,[option, option_value]);
%
% data: 2D data matrix
...
if(dim==2)
    z=bsxfun(@rdivide,a,mean(a(:,baseline_idx),2));
elseif(dim==1)
    z=bsxfun(@rdivide,a,mean(a(baseline_idx,:),1));    
else
    fprintf('dimension must be 1 or 2.\nerror!\n');
    return;    
end;
