...
#ifndef __complex_mex_interface_h
#define __complex_mex_interface_h 1
...
extern void InitializeModule_complex_mex_interface(void);
extern void TerminateModule_complex_mex_interface(void);
extern _mexLocalFunctionTable _local_function_table_complex;
