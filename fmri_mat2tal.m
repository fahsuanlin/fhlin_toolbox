function [out]=fmri_mat2tal(inp,matrix_size)
% fmri_mat2tal converting matrix indices to Talarich space
%
% output=fmri_mat2tal(input,matrix_size)
%
...
% output: a vector of x, y,and z coordinates of Talairach space
%
...
%converting MNI space to Talairach space
out=fmri_mni2tal(out);
