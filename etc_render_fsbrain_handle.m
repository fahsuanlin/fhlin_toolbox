...
try
    ...
    %for time_idx=1:size(X_dspm,2)
        ...
        etc_render_fsbrain.overlay_vol.vol=fmri_smooth(tmp,8);
        
        %figure(10);
        %fmri_overlay(etc_render_fsbrain.vol.vol,etc_render_fsbrain.overlay_vol.vol,'>',etc_render_fsbrain.overlay_threshold);
    %end;
    %fprintf('\n');
catch ME
end;
