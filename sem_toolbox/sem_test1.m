...
path(2).node_from{1}='B';
path(2).node_to{1}='C';
path(2).val=inf;
path(2).flag_uni{1}=1;

path(3).node_from{1}='C';
path(3).node_to{1}='D';
path(3).val=inf;
path(3).flag_uni{1}=1;
...
sa=0.3;     % endogenous power of node_A
sb=0.9;     % endogenous power of node_B
sc=2.1;     % endogenous power of node_C
sd=1.2;     % endogenous power of node_D
